...
RUN wget -q https://github.com/outbrain/zookeepercli/releases/download/v1.0.5/zookeepercli_1.0.5_amd64.deb -O /tmp/zookeepercli_1.0.5_amd64.deb
RUN dpkg -i /tmp/zookeepercli_1.0.5_amd64.deb
